                ...
                if(status == "success") {
                  if(data.status == "success") {
                    ...
                    console.log(data.hex);
                      ...
                      clearMarkersAndAnnotations();
                      markers.push(editor.session.addMarker(new Range(data.line_number-1, 0, data.line_number-1, 1), "compilerError", "fullLine"));
                      ...
                      console.log("error on line " + data.line_number + ": " + data.error);
                  } else {
